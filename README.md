...
*	Низкие системные требования. Так как не все устройства получают последнее обновление ПО, то данное приложение должно быть совместимо и с более ранними версиями ОС Android (не ниже версии 4.4).
